...
@section('Content')
@section('Title','Rejected Applications List | ORIGIN INTERNATIONAL COLLEGE')
@section('Styles')
<style>
  .user_label{
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4>Rejected Applications List</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        <h4 class="card-title">Rejected Applications List</h4>
